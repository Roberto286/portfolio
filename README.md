...
We have an example configuration under `site` folder that will let you run the theme locally. Follow below steps to run the example site.
...
Now, you can make change in the theme and they will be reflected immediately on the running site. If you need to change any configuration, you can do that in the `hugo.yaml` file inside `site` folder. If you need to add any content or data, you can create the respective folder inside `site` directory and add your desired content or data there.
